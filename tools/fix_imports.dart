...
void main() async {
  ...
  for (final file in files) {
    ...
    if (content.contains('presentation/theme/theme.dart') ||
        content.contains('../theme/theme.dart')) {
      content = content.replaceAll(
        RegExp(r"import '.*presentation/theme/theme\.dart';"),
        "import 'package:jewellary_stock/theme/app_theme.dart';",
      );
      content = content.replaceAll(
        RegExp(r"import '\.\./theme/theme\.dart';"),
    ...
    if (content.contains('presentation/widgets/')) {
      content = content.replaceAll(
        RegExp(r"import '.*presentation/widgets/(.*)';"),
        r"import 'package:jewellary_stock/widgets/$1';",
      );
      changed = true;
    }
    ...
    if (content.contains('presentation/state/')) {
      content = content.replaceAll(
        RegExp(r"import '.*presentation/state/(.*)';"),
        r"import 'package:jewellary_stock/blocs/$1';",
      );
      changed = true;
    }
    ...
    if (content.contains('domain/entities/')) {
      content = content.replaceAll(
        RegExp(r"import '.*domain/entities/(.*)_entity\.dart';"),
        r"import 'package:jewellary_stock/data/models/$1_model.dart';",
      );
      content = content.replaceAll(
        RegExp(r"import '\.\./\.\./domain/entities/(.*)_entity\.dart';"),
        r"import '../../data/models/$1_model.dart';",
      );
    ...
    if (content.contains('domain/usecases/')) {
      ...
      content = content.replaceAll(
        RegExp(r"import '.*domain/usecases/.*';\n?"),
        "",
      );
      changed = true;
    }
    ...
    if (content.contains('presentation/screens/')) {
      content = content.replaceAll(
        RegExp(r"import '.*presentation/screens/(.*)';"),
        r"import 'package:jewellary_stock/screens/$1';",
      );
      changed = true;
    }
